; (function () {
	...
	var goToTop = function () {
		$('.js-gotop').on('click', function (event) {
			// Evitar que el comportamiento por defecto del enlace se interrumpa si es el enlace de WhatsApp
			if ($(this).hasClass('whatsapp-link')) {
				return true; // Permitir que el enlace se abra
			}
